...
## Current dictionary snapshot (2026-08-17 build)

| File | Variant | Entries |
|------|---------|---------|
| `data/generated/dict_clean_sc.txt` | Simplified Chinese | 188,961 |
| `data/generated/dict_clean_tc.txt` | Traditional Chinese | 191,854 |
...
The build also derives a separate offline transition-completion index from strongly supported exact-word paths. It stores at most one vetted local completion for each typed prefix, remains lower priority than user and base exact completions, and is not counted as directly inputable dictionary data.
