...
## Current dictionary snapshot (2026-06-11 build)

| File | Variant | Entries |
|------|---------|---------|
| `data/generated/dict_clean_sc.txt` | Simplified Chinese | 175,052 |
| `data/generated/dict_clean_tc.txt` | Traditional Chinese | 178,675 |
| `data/generated/dict_unihan_sc.txt` | Simplified single-char (Unihan) | 23,905 |
| `data/generated/dict_unihan_tc.txt` | Traditional single-char (Unihan) | 24,164 |
