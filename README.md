...
## Current dictionary snapshot (2026-09-12 build)

| File | Variant | Entries |
|------|---------|---------|
| `data/generated/dict_clean_sc.txt` | Simplified Chinese | 189,406 |
| `data/generated/dict_clean_tc.txt` | Traditional Chinese | 192,362 |
| `data/generated/dict_unihan_sc.txt` | Simplified single-char (Unihan) | 23,913 |
| `data/generated/dict_unihan_tc.txt` | Traditional single-char (Unihan) | 24,172 |
