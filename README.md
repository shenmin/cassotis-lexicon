...
## Current dictionary snapshot (2026-05-25 build)

| File | Variant | Entries |
|------|---------|---------|
| `data/generated/dict_clean_sc.txt` | Simplified Chinese | 170,940 |
| `data/generated/dict_clean_tc.txt` | Traditional Chinese | 192,994 |
| `data/generated/dict_unihan_sc.txt` | Simplified single-char (Unihan) | 23,911 |
| `data/generated/dict_unihan_tc.txt` | Traditional single-char (Unihan) | 24,162 |
