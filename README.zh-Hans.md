...
## 当前词库快照（2026-09-10 构建）

| 文件 | 变体 | 词条数 |
|------|------|--------|
| `data/generated/dict_clean_sc.txt` | 简体主词库 | 189,378 |
| `data/generated/dict_clean_tc.txt` | 繁体主词库 | 192,334 |
| `data/generated/dict_unihan_sc.txt` | 简体单字（Unihan） | 23,912 |
| `data/generated/dict_unihan_tc.txt` | 繁体单字（Unihan） | 24,171 |
