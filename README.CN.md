...
## 当前词库快照（2026-05-12 构建）

| 文件 | 变体 | 词条数 |
|------|------|--------|
| `data/generated/dict_clean_sc.txt` | 简体主词库 | 170,057 |
| `data/generated/dict_clean_tc.txt` | 繁体主词库 | 178,856 |
| `data/generated/dict_unihan_sc.txt` | 简体单字（Unihan） | 23,923 |
| `data/generated/dict_unihan_tc.txt` | 繁体单字（Unihan） | 24,087 |
