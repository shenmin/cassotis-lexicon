...
## 当前词库快照（2026-08-06 构建）

| 文件 | 变体 | 词条数 |
|------|------|--------|
| `data/generated/dict_clean_sc.txt` | 简体主词库 | 188,782 |
| `data/generated/dict_clean_tc.txt` | 繁体主词库 | 191,686 |
...
|---|---:|---:|---:|
| 当前开发版本 | 23,593 / 22,717 | 281,091 / 250,354 | 698,695 / 698,778 |
