...
## 当前词库快照（2026-08-04 构建）

| 文件 | 变体 | 词条数 |
|------|------|--------|
| `data/generated/dict_clean_sc.txt` | 简体主词库 | 188,755 |
| `data/generated/dict_clean_tc.txt` | 繁体主词库 | 191,659 |
...
当前开发版本新增由语料证据支持、约束严格的 1+2 和 2+1 精确词转移，用于改善三音节短词续接，同时避免引入缺乏依据的组合。
