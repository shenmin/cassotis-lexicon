...
## 当前词库快照（2026-04-13 构建）

| 文件 | 变体 | 词条数 |
|------|------|--------|
| `data/generated/dict_clean_sc.txt` | 简体主词库 | 157,807 |
| `data/generated/dict_clean_tc.txt` | 繁体主词库 | 174,510 |
| `data/generated/dict_unihan_sc.txt` | 简体单字（Unihan） | 23,916 |
| `data/generated/dict_unihan_tc.txt` | 繁体单字（Unihan） | 24,069 |
