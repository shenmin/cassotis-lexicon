param(
    ...
    [string]$OutputCompletionPriorSc = "",
    [string]$OutputCompletionPriorTc = "",
    [string]$OutputCompletionLookupSc = "",
    [string]$OutputCompletionLookupTc = "",
...
if ($OutputCompletionPriorSc -ne "") { $args += @("--completion-prior-output-sc", $OutputCompletionPriorSc) }
if ($OutputCompletionPriorTc -ne "") { $args += @("--completion-prior-output-tc", $OutputCompletionPriorTc) }
if ($OutputCompletionLookupSc -ne "") { $args += @("--completion-lookup-output-sc", $OutputCompletionLookupSc) }
if ($OutputCompletionLookupTc -ne "") { $args += @("--completion-lookup-output-tc", $OutputCompletionLookupTc) }
